            ...
            <div className="lg:col-span-7 bg-white p-12 rounded-[4rem] shadow-xl border border-white relative overflow-hidden">
              ...
              <div className="mb-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6">
                  ...
                  >
                    <Calendar className={`mx-auto mb-4 ${bookingMode === 'range' ?  'text-blue-600' : 'text-slate-400'}`} size={40} />
                    <h3 className={`text-xl font-black mb-2 ${bookingMode === 'range' ? 'text-blue-900' : 'text-slate-700'}`}>
                      區間預約
                    </h3>
                  ...
                  >
                    <Calendar className={`mx-auto mb-4 ${bookingMode === 'single' ? 'text-blue-600' : 'text-slate-400'}`} size={40} />
                    <h3 className={`text-xl font-black mb-2 ${bookingMode === 'single' ? 'text-blue-900' : 'text-slate-700'}`}>
                      單日預約
                    </h3>
                    <p className="text-sm font-bold text-slate-500">
                      指定特定日期預約
                ...
                {bookingMode === 'single' && (
                  <div className="bg-blue-50 p-8 rounded-[2.5rem] border-2 border-blue-200 animate-in slide-in-from-top duration-500">
                    ...
                    <input
                      ...
                      min={todayISO()}
                      className="w-full p-4 rounded-2xl border-2 border-blue-300 focus:border-blue-500 focus:ring-0 text-lg font-bold text-slate-700"
                    />
                  </div>
                )}
              </div>
            ...
            <div className="lg:col-span-5 space-y-10">
              ...
              <div className="bg-white p-10 rounded-[3.5rem] border border-blue-50 shadow-xl relative overflow-hidden">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-400 mt-2 ml-11">
                      {getTodayDate()}
                    </p>
                  </div>
              ...
              <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-xl">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="bg-blue-50 text-blue-600 px-4 py-1 rounded-full text-sm font-black uppercase tracking-widest">
                    {intervalDays} 天統計
                  </div>
                </div>
                      ...
                      >
                        <div className="flex justify-between items-center mb-5">
                          <div className="flex items-center gap-3">
                            <div className="text-lg font-black text-slate-800">{doc.name}</div>
                            <span className="text-xs bg-white border px-2 py-0.5 rounded text-slate-400 uppercase">
                              {doc.level}
                            </span>
                          </div>
                          <div className="text-2xl font-black text-blue-600">
                            {personalStats?.total} <span className="text-xs text-slate-300 ml-1">人次</span>
                          </div>
                        </div>
              ...
              <div className="bg-slate-900 p-8 rounded-[3rem] text-white shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-lg font-black tracking-widest uppercase">全院區間摘要</h2>
                  </div>
                  <div className="text-3xl font-black text-white tracking-tighter mb-6">
                    {displayStats.total} <span className="text-sm font-bold text-blue-400 ml-1">人次累計</span>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-xs font-black uppercase tracking-widest text-slate-400">
                    <div className="flex items-center gap-2">
